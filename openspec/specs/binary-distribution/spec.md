...
## Purpose
Defines how the `k8s-ready` CLI is built, named, and published as standalone executable binaries attached to GitHub Releases. Covers the multi-architecture naming convention, self-contained executable requirements, version flag support, and the GitHub Release publishing workflow.
